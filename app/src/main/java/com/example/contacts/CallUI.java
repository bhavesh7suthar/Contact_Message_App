...
public class CallUI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number_input = (EditText) findViewById(R.id.number);
        ...
        call_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int check_permission = ContextCompat.checkSelfPermission(CallUI.this, Manifest.permission.CALL_PHONE);

                if (check_permission == PackageManager.PERMISSION_GRANTED) {
                    makePhoneCall();
                } else {
                    ActivityCompat.requestPermissions(CallUI.this, new String[]{Manifest.permission.CALL_PHONE}, request_Code);
                }
            }
        });
    }
